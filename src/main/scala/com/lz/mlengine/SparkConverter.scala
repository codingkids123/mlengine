...
import com.lz.mlengine.classification.{DecisionTreeClassificationModel, LinearSVCModel, LogisticRegressionModel}
import com.lz.mlengine.regression.{DecisionTreeRegressionModel, LinearRegressionModel}
